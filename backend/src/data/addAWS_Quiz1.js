      ...
      switch (_a.label) {
        ...
        case 3:
          ...
          awsQuestions = [
            {
              questionText:
                "What is the primary service in AWS for hosting static websites?",
              options: [
            ...
            },
            {
              ...
              options: [
                ...
                {
                  text: "Amazon Elastic Compute Cloud (Amazon EC2) Spot Fleet",
                  isCorrect: false,
                },
                {
            ...
            },
            {
              ...
              options: [
                ...
                {
                  text: "Amazon Machine Learning (Amazon ML)",
                  isCorrect: false,
                },
              ],
              category: 2,
            ...
            },
            {
              ...
              options: [
                {
                  text: "Cloud resources can be managed programmatically",
                  isCorrect: true,
                },
                {
                  text: "AWS infrastructure use will always be cost-optimized",
                  isCorrect: false,
                },
                {
                  text: "All application testing is managed by AWS",
                  isCorrect: false,
                },
                {
                  text: "Customer -owned, on -premises infrastructure becomes programmable",
                  isCorrect: false,
                },
              ],
              category: 2,
            },
            {
              ...
              options: [
                ...
                {
                  text: "Adding an elastic load balancer in front of a single Amazon Elastic Computer Cloud (Amazon EC2) instance",
                  isCorrect: false,
                },
                {
                  text: "Creating and deploying the most cost-effective solution",
                  isCorrect: false,
                },
                {
                  text: "Using Amazon CloudWatch alerts to monitor performance",
                  isCorrect: false,
                },
              ],
              category: 2,
            ...
            },
            {
              ...
              options: [
                {
                  text: "Managing AWS Identity and Access Management (IAM)",
                  isCorrect: true,
                },
                { text: "Securing edge locations", isCorrect: false },
                {
                  text: "Monitoring physical device security",
                  isCorrect: false,
                },
                {
                  text: "Implementing service organization Control (SOC) standards",
                  isCorrect: false,
                },
              ],
              category: 2,
            },
            {
              ...
              options: [
                ...
                {
                  text: "AWS Cloud Trail logs stored in Amazon Simple Storage Service  Amazon S3)",
                  isCorrect: false,
                },
              ],
              category: 2,
            ...
            },
            {
              ...
              options: [
                {
                  text: "Reduce inter-dependencies so failures do not impact other components.",
                  isCorrect: true,
                },
                {
                  text: "Create a tightly integrated application.",
                  isCorrect: false,
                },
                {
                  text: "Enable data synchronization across the web application layer.",
                  isCorrect: false,
                },
                {
                  text: "Have the ability to execute automated bootstrapping actions.",
                  isCorrect: false,
                },
              ],
              category: 2,
            },
            {
              ...
              options: [
                {
                  text: "It increases the availability of an application compared to running in a single Availability Zone.",
                  isCorrect: true,
                },
                {
                  text: "It is more secure than running in a single Availability Zone.",
                  isCorrect: false,
                },
                {
                  text: "It significantly reduces the total cost of ownership versus running in a single Availability Zone.",
                  isCorrect: false,
                },
                {
                  text: "Performance is improved over running in a single Availability Zone.",
                  isCorrect: false,
                },
              ],
              category: 2,
            },
            {
              ...
              options: [
                {
                  text: "Password Policies and User permissions",
                  isCorrect: true,
                },
            ...
            },
            {
              ...
              options: [
                {
                  text: "Create systems that scale to the required capacity based on changes in demand.",
                  isCorrect: true,
                },
                {
                  text: "Minimize storage requirements by reducing logging and auditing activities.",
                  isCorrect: false,
                },
                {
                ...
                {
                  text: "Accelerate the design process because recovery from failure is automated, reducing the need for testing.",
                  isCorrect: false,
                },
              ],
              category: 2,
            },
            {
              ...
              options: [
                {
                  text: "Workloads where the availability of the Amazon EC2 instances can be flexible.",
                  isCorrect: true,
                },
                {
                  text: "Workloads that are only run in the morning and stopped at night.",
                  isCorrect: false,
                },
                {
                  text: "Workloads that need to run for long periods of time without interruption.",
                  isCorrect: false,
                },
                {
                  text: "Workloads that are critical and need Amazon EC2 instances with termination protection.",
                  isCorrect: false,
                },
              ],
              category: 2,
            },
            {
              ...
              options: [
                {
                  text: "AWS Management Console, Amazon Cloud Watch",
                  isCorrect: true,
                },
                {
                  text: "AWS Application Programming Interface (API)",
                  isCorrect: false,
                },
                {
            ...
            },
            {
              ...
              options: [
                {
                  text: "Apply Multi-Factor Authentication (MFA)",
                  isCorrect: true,
                },
            ...
            },
            {
              ...
              options: [
                {
                  text: "The number of servers migrated to AWS",
                  isCorrect: true,
                },
                {
                  text: "The number of users migrated to AWS",
                  isCorrect: false,
                },
                {
                  text: "The number of passwords migrated to AWS",
                  isCorrect: false,
                },
                {
                  text: "The number of keys migrated to AWS",
                  isCorrect: false,
                },
              ],
              category: 2,
            ...
            {
              questionText:
                "A company is deploying a two-tier, high availability web application to AWS. Which service provides durable static content while utilizing lower Overall CPU resources for the web tier?",
              options: [
            ...
            },
            {
              ...
              options: [
                {
                  text: "Users should be granted permission to access only resources they need to do their assigned job.",
                  isCorrect: true,
                },
                {
                  text: "All users should have the same baseline permissions granted to them to use basic AWS services.",
                  isCorrect: false,
                },
                {
                  text: "Users should submit all access requests in writing so that there is a paper trail of who needs access to different AWS resources.",
                  isCorrect: false,
                },
                {
                  text: "Users should always have a little more access granted to them then they need, just in case they end up needing it in the future.",
                  isCorrect: false,
                },
              ],
              category: 2,
            ...
            {
              questionText:
                "Which of the following can be used to protect EC2 Instances hosted in AWS.",
              options: [
                {
                  text: "Usage of Security Groups, Usage of Network Access Control Lists",
                  isCorrect: true,
                },
            ...
            {
              questionText:
                "You work for a company that is planning on using the AWS EC2 service. They currently create golden images of their deployed Operating system. Which of the following correspond to a gold image in AWS.",
              options: [
            ...
            },
            {
              ...
              options: [
                {
                  text: "Choose AWS services which are PCI compliant, Ensure the right steps are taken during application development for PCI Compliance",
                  isCorrect: true,
                },
                {
                  text: "Ensure the AWS Services are made PCI Compliant",
                  isCorrect: false,
                },
                {
                  text: "Do an audit after the deployment of the application for PCI Compliance",
                  isCorrect: false,
                },
              ],
              category: 2,
            ...
            {
              questionText:
                "Which of the below can not be used to get data onto Amazon Glacier?",
              options: [
            ...
            {
              questionText:
                "Which of the following in the AWS Support plan D gives access to a Support Concierge:",
              options: [
            ...
            },
            {
              ...
              options: [
                {
                  text: "Distribute load across multiple resources",
                  isCorrect: true,
                },
                { text: "Distribute content to users", isCorrect: false },
                { text: "Cache common responses", isCorrect: false },
                {
                  text: "Used in conjunction with the Cloudfront service",
                  isCorrect: false,
                },
              ],
              category: 2,
            ...
            },
            {
              ...
              options: [
                {
                  text: "Giving a name and description for the security group.",
                  isCorrect: true,
                },
                {
                  text: "Ensure the rules are applied immediately.",
                  isCorrect: false,
                },
                {
                  text: "Ensure the security groups are linked to the Elastic Network interface.",
                  isCorrect: false,
                },
              ],
              category: 2,
            },
            {
              ...
              options: [
                ...
                {
                  text: "Having no need to worry about security",
                  isCorrect: false,
                },
                {
                  text: "Having complete control over the physical infrastructure.",
                  isCorrect: false,
                },
              ],
              category: 2,
            ...
            {
              questionText:
                "There is an external audit being carried out on your company. The IT auditor needs to have a log of all access for the AWS resources in the company account. Which of the below services can assist in providing these details?",
              options: [
            ...
            {
              questionText:
                "Your company has a set of EC2 instances hosted on AWS. There is a requirement to create snapshots from the EBS volumes attached to these EC2 instances in another geographical location. As per this requirement, where would you create the snapshots?",
              options: [
            ...
            },
            {
              ...
              options: [
                {
                  text: "Hosting a database on an EC2 Instance",
                  isCorrect: true,
                },
            ...
            },
            {
              ...
              options: [
                {
                  text: "Diverting traffic to instances based on the demand",
                  isCorrect: true,
                },
                {
                  text: "Diverting traffic across multiple regions",
                  isCorrect: false,
                },
                {
                  text: "Diverting traffic to instances with higher capacity",
                  isCorrect: false,
                },
              ],
              category: 2,
            },
            {
              ...
              options: [
                {
                  text: "To distribute traffic to multiple EC2 instances",
                  isCorrect: true,
                },
                { text: "To scale up EC2 instances", isCorrect: false },
                {
                  text: "To distribute traffic to AWS resources across multiple regions",
                  isCorrect: false,
                },
                {
                  text: "To increase the size of the EC2 Instance based on demand",
                  isCorrect: false,
                },
              ],
              category: 2,
            },
            {
              ...
              options: [
                {
                  text: "To scale up resources based on demand",
                  isCorrect: true,
                },
                {
                  text: "To distribute traffic to multiple EC2 instances",
            ...
            },
            {
              ...
              options: [
                ...
                {
                  text: "Deleting the data when the device is destroyed",
                  isCorrect: false,
                },
                {
                  text: "Attaching volumes to EC2 instances",
                  isCorrect: false,
                },
            ...
            {
              questionText:
                "Which of the following is a way that AWS allows linking accounts?",
              options: [
            ...
            },
            {
              ...
              options: [
                {
                  text: "The ability to only pay for what you use.",
                  isCorrect: true,
                },
                {
                  text: "Having the ability of automated backups of the EC2 instance, so that you do not need to worry about the maintenance costs",
                  isCorrect: false,
                },
                {
                  text: "The ability to choose low cost AMI to prepare the EC2 instances.",
                  isCorrect: false,
                },
                {
                  text: "Ability to tag instances to reduce the overall cost.",
                  isCorrect: false,
                },
              ],
              category: 2,
            ...
            {
              questionText:
                "Your company is planning on moving to the AWS Cloud. Once the movement to the Cloud is complete, they want to ensure that the right security settings are put in place. Which of the below tools can assist from a Security compliance?",
              options: [
            ...
            {
              questionText:
                "Which of the following services is most useful when a Disaster Recovery method is triggered in AWS.",
              options: [
                { text: "Amazon Route 53", isCorrect: true },
            ...
            {
              questionText:
                'When designing a system, you use the principle of "design for failure and nothing will fail." Which of the following services /features of AWS can NOT assist in supporting this design principle?',
              options: [
            ...
            {
              questionText:
                "Which of the following is NOT the responsibility of AWS according to the Shared Security Model?",
              options: [
                {
                  text: "Managing AWS Identity and Access Management (IAM)",
                  isCorrect: true,
            ...
            },
            {
              ...
              options: [
                {
                  text: "By using the AWS Cost and Usage reports Explorer. Here you can see the running and forecast costs.",
                  isCorrect: true,
                },
                {
                  text: "By going to the Amazon EC2 dashboard. Here you can see the costs of the running EC2 resources.",
                  isCorrect: false,
                },
                {
                  text: "By using the AWS Trusted Advisor dashboard.This dashboard will give you all the cost.",
                  isCorrect: false,
                },
                {
                  text: "By seeing the AWS Cloud Trail logs.",
                  isCorrect: false,
                },
              ],
              category: 2,
            ...
            {
              questionText:
                "Your design team is planning to design an application that will be hosted on the AWS Cloud. One of their main non-functional requirements is given below. Reduce interdependencies so failures do not impact other components. Which of the following concepts does this requirement relate to?",
              options: [
            ...
            },
            {
              ...
              options: [
                {
                  text: "Deploying resources across multiple AvailabilityZones.",
                  isCorrect: true,
                },
                {
                ...
                {
                  text: "Deploying resources across multiple VPCs.",
                  isCorrect: false,
                },
                {
                  text: "Deploying resources across multiple AWS accounts.",
                  isCorrect: false,
                },
              ],
              category: 2,
            ...
            {
              questionText:
                "Which of the following security requirements are NOT managed by AWS?",
              options: [
            ...
            {
              questionText:
                "Your company is planning to offload some of the batch processing workloads on AWS. These jobs can be interrupted and resumed at any time. Which of the following instance types would be the most cost effective to use for this purpose?",
              options: [
            ...
            {
              questionText:
                "Which of the following can be used as an additional layer of security to use a username and password when logging into the AWS Console.",
              options: [
            ...
            },
            {
              ...
              options: [
                ...
                {
                  text: "AWS Elastic Compute Cloud (Amazon EC2)",
                  isCorrect: false,
                },
            ...
            },
            {
              ...
              options: [
                {
                  text: "Deploying the application across multiple Regions",
                  isCorrect: true,
                },
                {
                  text: "Deploying the application across multiple VPCs",
                  isCorrect: false,
                },
                {
                  text: "Deploying the application across Edge locations",
                  isCorrect: false,
                },
                {
                  text: "Deploying the application across multiple subnets",
                  isCorrect: false,
                },
              ],
              category: 2,
            },
            {
              ...
              options: [
                {
                  text: "They continually reduce the cost of cloud computing",
                  isCorrect: true,
                },
                { text: "The decommission older hardware", isCorrect: false },
                {
                  text: "They use better security mechanisms so you dont need to think about security at all",
                  isCorrect: false,
                },
                {
                  text: "They allow deployment of multiple resources",
                  isCorrect: false,
                },
              ],
              category: 2,
            ...
            {
              questionText:
                "Which of the following is not a category given by the AWS TrustedAdvisor?",
              options: [
            ...
            {
              questionText:
                "You have a set of EC2 Instances hosted on the AWS Cloud. The EC2 Instances are hosting a web application. If you have a DDOS attack from the internet. Which of the following can help in reducing the overall threat to your EC2 Instances?",
              options: [
                {
                  text: "Usage of Network Access Control Lists",
                  isCorrect: true,
                },
            ...
            {
              questionText:
                "Which of the following are NOT features of an edge location. ",
              options: [
                {
                  text: "Distribute load across multiple resources",
                  isCorrect: true,
            ...
            {
              questionText:
                "There is a requirement to host a set of servers in the Cloud for a short period of 6 months. Which of the following types of instances should be chosen to be cost effective?",
              options: [
                { text: "On-demand", isCorrect: true },
                { text: "Spot Instances", isCorrect: false },
          ...
          return [
            4 /*yield*/,
            quizModel_1["default"].deleteMany({ title: "Synthetic AWS Exam" }),
          ];
        case 4:
          _a.sent();
          return [
            4 /*yield*/,
            quizModel_1["default"].create({
              title: "Synthetic AWS Exam",
              description:
                "A set of questions to review essential knowledge for AWS certification.",
              price: 0,
            }),
          ];
        case 5:
          awsExamQuiz_1 = _a.sent();
          questionsWithQuizId = awsQuestions.map(function (question) {
            return __assign(__assign({}, question), {
              quizId: awsExamQuiz_1._id,
            });
          });
          return [
            4 /*yield*/,
            questionModel_1["default"].insertMany(questionsWithQuizId),
          ];
        case 6:
          ...
          return [
            4 /*yield*/,
            quizModel_1["default"].findByIdAndUpdate(awsExamQuiz_1._id, {
              $push: {
                questions: {
                  $each: insertedQuestions.map(function (q) {
                    return q._id;
                  }),
                },
              },

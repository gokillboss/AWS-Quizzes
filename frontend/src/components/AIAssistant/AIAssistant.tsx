...
const AIAssistant: React.FC<AIAssistantProps> = ({ 
    ...
    const suggestedQuestions = [
        "Giải thích chi tiết hơn về câu hỏi này",
        "Tại sao đáp án này đúng/sai?",
        "Có best practices nào liên quan không?",
        "Làm sao để nhớ concept này tốt nhất?",
        "Các services AWS nào liên quan?"
    ];
                ...
                <div className="messages-wrapper">
                    {messages.length === 0 ? (
                        <div className="text-center text-muted empty-message p-4">
                            ...
                            <p>Hãy đặt câu hỏi hoặc nhấn "Phân tích câu hỏi" để được trợ giúp.</p>
                            
                            <div className="suggested-questions mt-3">
                                <p className="small text-muted mb-2">Câu hỏi gợi ý:</p>
